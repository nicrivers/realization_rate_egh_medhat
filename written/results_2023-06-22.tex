...
\begin{frame}{Summary statistics}
	...
	\input{../output_figures_tables/both_sumtable}
\end{frame}
...
\begin{frame}{TWFE estimates for total energy; monthly data}
	\input{../output_figures_tables/twfe_monthly_energy.tex}
\end{frame}

\begin{frame}{TWFE estimates for gas; monthly data}
	\input{../output_figures_tables/twfe_monthly_gas.tex}
\end{frame}

\begin{frame}{TWFE estimates for electricity; monthly data}
	\input{../output_figures_tables/twfe_monthly_elec.tex}
\end{frame}
...
\begin{frame}{TWFE estimates for energy; annual data}
	\input{../output_figures_tables/twfe_annual_energy.tex}
\end{frame}

\begin{frame}{Sun+Abraham estimates for energy; annual data}
	\input{../output_figures_tables/sunab_annual_energy.tex}
\end{frame}

\begin{frame}{Sun+Abraham estimates for gas; annual data}
	\input{../output_figures_tables/sunab_annual_gas.tex}
\end{frame}

\begin{frame}{Sun+Abraham estimates for electricity; annual data}
	\input{../output_figures_tables/sunab_annual_elec.tex}
\end{frame}
...
\begin{frame}{Realization rates}
	...
	\input{../output_figures_tables/overall_realizationrate_log}
\end{frame}
...
\begin{frame}{Dollar savings}
	...
	\input{../output_figures_tables/dollar_savings}
\end{frame}
